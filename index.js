//import files using require method
const inquirer = require("inquirer");
const fs = require("fs");
const util = require("util");
const writeFileAsync = util.promisify(fs.writeFile);

// function to loop through quesitions
function promptUser() {
...
// function that layout the ReadMe File
...
// Alert prompt to user when done going through questions
promptUser()
